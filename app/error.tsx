    ...
    <main className="min-h-[100dvh] bg-base flex items-center justify-center px-4">
      <div className="text-center max-w-sm">
        <div className="w-14 h-14 rounded-2xl bg-danger-dim/30 border border-danger/20 flex items-center justify-center mx-auto mb-5">
          <Warning size={28} weight="duotone" className="text-danger" aria-hidden="true" />
        </div>
        ...
        <button
          onClick={() => reset()}
          className="tactile-press bg-accent text-base font-semibold text-sm rounded-xl px-6 py-3 hover:bg-accent-hover focus-visible:ring-2 focus-visible:ring-accent focus-visible:outline-none transition-colors"
        >
          Tentar novamente
        </button>
      </div>
