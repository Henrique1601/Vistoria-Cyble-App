  ...
  return (
    ...
    >
      <motion.div
        ...
        exit={{ y: 20, opacity: 0 }}
        transition={spring}
        className="glass-modal rounded-3xl w-full max-w-sm p-5 space-y-4 shadow-2xl border border-white/[0.1]"
      >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              value={aptoEdit}
              onChange={(e) => setAptoEdit(e.target.value)}
              placeholder="Ex: 107"
        ...
        <button
          ...
          disabled={!data || !aptoEdit.trim() || salvando}
