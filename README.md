...
## Recursos Recentes (v3.8.3)
- **Status Preciso de Fotos & Andamento:** Granularidade total entre fotos remotas (Blob/Neon) e locais, garantindo que fotos parciais (ex: apenas Cyble Antes ou Cyble Depois) sejam computadas fielmente como "Em Andamento" com pontinhos de alerta âmbar e não como concluídos falsos.
